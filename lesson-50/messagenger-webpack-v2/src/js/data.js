...
addCommentToMessage(0, new Comment(0,0, 'very good',new Date().toLocaleDateString()));
addCommentToMessage(0, new Comment(1,0, 'nice to see you', new Date().toLocaleDateString()));
addCommentToMessage(1, new Comment(2,1, 'hello!', new Date().toLocaleDateString()));
addCommentToMessage(1, new Comment(0,1, 'good bye!', new Date().toLocaleDateString()));
